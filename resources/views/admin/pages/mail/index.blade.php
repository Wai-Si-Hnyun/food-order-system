...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible border border-success mx-auto col-lg-8 col-md-9 col-sm-10"
                role="alert">
                {{ session('success') }}
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        @endif
        <div class="card col-lg-8 col-md-9 col-sm-10 mx-auto my-5 border border-gray-50 p-sm-5 p-2">
            <h4 class="card-header text-center pb-3">Email Information</h4>
            <div class="card-body">
                <form action="{{ route('mail.send') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="recipient_email" class="form-label">Recipient Email:<span
