                        ...
                        <div class="text-center">
                            @if ($user->image == null)
                                <img src="{{ asset('image/profile.png') }}"
                                    class="avatar img-circle  w-50 h-50" alt="avatar" id="profile">
                                <img id="output" class=" rounded-circle w-75 h-75">
                            @else
                                <img src="{{ asset('storage/'.$user->image) }}"
                                    class=" rounded-circle w-75 h-75" alt="avatar" id="profile">
                                <img id="output" class=" rounded-circle w-75 h-75">
                            @endif
